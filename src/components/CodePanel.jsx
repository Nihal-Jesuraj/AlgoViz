...
function CodePanel({ code = '', language = 'java', currentLine = -1, title = 'Code', hideHeader = false, themeId = 'apple' }) {
  ...
  return (
    <div id="code-panel" className="glass-card flex flex-col overflow-hidden h-full min-h-0">
      {/* Panel header */}
      {!hideHeader && (
        <div className="flex items-center justify-between px-4 py-2.5 flex-shrink-0" style={{ borderBottom: '1px solid var(--glass-border)' }}>
